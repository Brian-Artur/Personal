...
- `ordenes` — el intento de ejecución en Bybit (el corazón)
  logseq.order-list-type:: number
	...
	- `avg_price` — precio medio de ejecución. Porque se puede comprar a distintos mejor precio del que pusiste como límite. O se puede comprar a mercado a distintos precios
